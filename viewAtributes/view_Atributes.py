...
class viewAtributes:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'viewAtributes_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&view atributes')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'viewAtributes')
        self.toolbar.setObjectName(u'viewAtributes')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('viewAtributes', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/viewAtributes/icon.png'
        self.add_action(
            icon_path,
